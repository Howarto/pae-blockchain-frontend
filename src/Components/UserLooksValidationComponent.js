...
class UserLooksValidationComponent extends Component {
  ...
  componentDidMount() {
    ...
    web3wrapper.runContractMethod(userAccount, UserLooksValidationComponent.contractAbi, UserLooksValidationComponent.contractAddress, 'isValidated', null, (result) => {
      debugger;
  ...
  render() {
    return <main role="main" className="container">
        ...
        <div className="row">
          <div className="col">
            <div className="summary">
              ...
              Partners y Red Dog de Marketing.
            </div>
          </div>
        </div>
        ...
        {this.state.hasCVAccess && <div className="row">
            <div className="col">
              <div className="aptitudes">
                <h3>
                  Estas aptitudes no se verían si no existiera en la
                  Blockchain la transacción
                </h3>
              </div>
            </div>
          </div>}
        ...
        {this.state.buttonClicked && <div className="row">
            <div className="col">
              <div className="askForValidations">
                <div className="row">
                  <div className="col">
